...
//           |           |              | ( SLP_TYPa   ) | ( SLP_TYPb   ) | (
//           Reserved   ) | (Reserved    )
// PackageOP | PkgLength | NumElements  | uint8_tprefix Num | uint8_tprefix Num
// | uint8_tprefix Num | uint8_tprefix Num 12        | 0A        | 04 | 0A 05 |
// 0A          05 | 0A         05  | 0A         05
//
...
//
// (Pkglength bit 6-7 encode additional PkgLength uint8_ts [shouldn't be the
// case here])
//
int initAcpi(void) {
